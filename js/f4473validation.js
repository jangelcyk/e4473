...
//    });
    ...
    $('#tt-name').tooltipster({
        trigger: 'click',
        maxWidth: 700,
        content: $("<p>The buyer must personally complete Section A of this form and certify <i>(sign)</i> that the answers are true, correct, and complete. However, if the buyer is unable to read and/or write, the answers <i>(other than the signature)</i> may be completed by another person, excluding the seller. Two persons <i>(other than the seller)</i> must then sign as witnesses to the buyer's answers and signature.</p><p>When the buyer of a firearm is a corporation, company, association, partnership, or other such business entity, an officer authorized to act on behalf of the business must complete Section A of the form with his or her personal information, sign Section A, and attach a written statement, executed under penalties of perjury, stating: (A) the firearm is being acquired for the use of and will be the property of that business entity and (B) the name and address of that business entity. If the buyer's name in question 1. is illegible, the seller must print the buyer's name above the name written by the buyer.</p>")
    });
